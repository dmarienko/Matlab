...
% The variance ratio test can be used to calculate the statistical 
% significance if the data in our data set are truly mean reverting. 
% It gives the p-value with which the null-hypothesis (that the data are a 
% random walk) can be rejected.
%
